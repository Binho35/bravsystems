...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen bg-[#f4f8fb] text-[#334155]">
      <SiteHeader />
      <section className="px-4 py-10 sm:px-6 sm:py-14">
        <article className="mx-auto max-w-4xl rounded-[28px] border border-[#dce6ed] bg-white p-6 shadow-sm sm:p-10 lg:p-12">
          ...
          <header className="mt-8 border-b border-[#e2e8f0] pb-8">
            <div className="text-xs font-bold uppercase tracking-[.18em] text-[#2563eb]">BravSystems</div>
            <h1 className="mt-3 text-4xl font-bold tracking-[-.04em] text-[#0b2947] sm:text-5xl">Política de Privacidade</h1>
            <p className="mt-5 text-base leading-7 text-[#64748b]">Esta política explica como os dados enviados pelo site institucional da BravSystems são utilizados no atendimento de solicitações comerciais e de contato.</p>
          </header>
          <div className="mt-8 space-y-8 text-[15px] leading-7">
            ...
            <section>
              ...
              <p className="mt-3">Solicitações sobre privacidade podem ser encaminhadas para <a href="mailto:contato@bravsystems.com.br" className="font-bold text-[#154b7a] underline">contato@bravsystems.com.br</a>.</p>
            </section>
            <section className="rounded-2xl border border-[#dce6ed] bg-[#f8fbfd] p-5">
              ...
              <p className="mt-2 text-sm text-[#64748b]">Este texto reflete o funcionamento técnico auditado do site. Antes de ser tratado como instrumento jurídico definitivo, recomenda-se revisão por profissional jurídico responsável pela BravSystems.</p>
            </section>
          </div>
        </article>
      </section>
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return <section><h2 className="text-xl font-bold text-[#0b2947]">{title}</h2><p className="mt-3">{children}</p></section>;
}
