...
export const products: Product[] = [
  ...
  },
  {
    slug: "bravclin",
    name: "BravClin",
    category: "Clínicas de estética e saúde",
    status: "Em desenvolvimento",
    headline: "Gestão clínica white label para uma jornada mais organizada, segura e próxima.",
    description: "O BravClin é a plataforma white label da BravSystems para clínicas de estética e saúde, reunindo agenda, relacionamento, pacientes, prontuário, anamnese, consentimentos, evolução, estoque, financeiro e automações em uma experiência própria por clínica.",
    pain: ["Agenda e confirmações desconectadas", "Histórico de pacientes e evolução espalhados", "Estoque, lotes e validade sem rastreabilidade central", "CRM, financeiro e comunicação operando em controles separados"],
    benefits: ["Visão integrada da clínica", "Experiência white label", "Mais rastreabilidade e organização", "Operação simples e mobile-first"],
    capabilities: ["Agenda e confirmações", "CRM comercial", "Cadastro e histórico de pacientes", "Prontuário e evolução", "Anamnese digital", "Consentimentos e autorizações", "Fotos de evolução / antes e depois", "Estoque, lote, validade e rastreabilidade", "Financeiro e indicadores", "Integração com WhatsApp e automações de pré e pós-consulta", "Gestão de equipe e permissões", "Estrutura multi-clínica / white label"],
    audience: ["Clínicas de estética", "Clínicas de saúde", "Operações multi-clínica que precisam de identidade e dados segregados"],
    limitations: ["Projeto em construção", "Módulos e integrações seguem evolução antes da liberação comercial", "Procedimentos e fluxos permanecem configuráveis conforme habilitação e regras aplicáveis"],
    cta: "Conhecer o BravClin",
  },
  {
    slug: "bravhas",
    name: "BravHas",
  ...
  {
    slug: "bravsystems-finance",
    name: "BravSystems Finance",
    category: "Dashboard financeiro e leitura executiva",
    status: "Em desenvolvimento",
    headline: "Transforme planilhas financeiras em uma leitura executiva mais simples e rápida.",
    description: "O BravSystems Finance transforma planilhas operacionais em uma visão executiva mobile de realizado, saldo, compromissos, projeções e investimentos, preservando o processamento local dos arquivos por padrão.",
    pain: ["Indicadores espalhados em planilhas extensas", "Leitura executiva lenta", "Dificuldade para acompanhar pagamentos e projeções", "Informações financeiras pouco acessíveis no mobile"],
    benefits: ["Leitura executiva rápida", "Visão de realizado e projeção", "Acompanhamento de pagamentos", "Processamento local por padrão"],
    capabilities: ["Upload local de XLSX e XLS", "KPIs financeiros", "Visão gerencial por categorias", "Evolução mensal", "Próximos pagamentos", "Visão de investimentos", "Persistência local do snapshot", "Exportação JSON", "PWA instalável"],
    audience: ["Gestores financeiros", "Lideranças administrativas", "Empresas que operam controles financeiros em planilhas"],
    limitations: ["Produto em evolução antes de liberação comercial ampla", "A disponibilidade de dados depende da estrutura das abas presentes na planilha", "Snapshots remotos permanecem opcionais e não substituem a fonte operacional"],
    cta: "Conhecer o BravSystems Finance",
  },
  {
    slug: "bravhos",
    name: "BravHos",
