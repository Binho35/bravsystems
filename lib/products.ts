...
export const products: Product[] = [
  ...
  },
  {
    slug: "bravhas",
    name: "BravHas",
    category: "Administração, financeiro e pessoas",
    status: "Em homologação",
    headline: "Controle administrativo real para financeiro, pessoas e obrigações.",
    description: "Suite administrativa da BravSystems para organizar financeiro, RH, DP, documentos e rotinas de gestão em um único centro de controle.",
  ...
  },
  {
    slug: "bravsocial",
    name: "BravSocial",
    category: "Gestão e publicação de conteúdo social",
    status: "Em homologação",
    headline: "Planeje, organize e publique conteúdo social com mais controle.",
    description: "O BravSocial organiza planejamento, calendário, publicação e acompanhamento de conteúdo social em uma experiência centralizada para marcas e equipes.",
    pain: ["Calendário social disperso", "Publicações sem visão centralizada", "Retrabalho entre criação e distribuição", "Dependência de controles paralelos"],
    benefits: ["Planejamento centralizado", "Mais rastreabilidade", "Menos retrabalho", "Visão clara da operação social"],
    capabilities: ["Calendário editorial", "Criação e organização de posts", "Fluxos de publicação", "Gestão de canais", "Histórico e status", "Experiência mobile"],
    audience: ["Empresas com presença digital", "Times de marketing e social media", "Marcas que precisam organizar produção e distribuição de conteúdo"],
    limitations: ["Integrações reais com provedores sociais dependem de ativos, permissões e homologação externa", "O ambiente permanece em homologação antes de liberação comercial"],
    cta: "Conhecer o BravSocial",
  },
  {
    slug: "bravacademy",
    name: "BravAcademy",
    ...
    description: "Capacitação, trilhas de aprendizagem, avaliações, progresso e certificação em um ambiente personalizado para sua empresa.",
    ...
    limitations: ["Ambiente atual em homologação; disponibilidade comercial definitiva depende de autorização posterior", "Políticas de reprodução e mídia devem respeitar o estado homologado do produto"],
    cta: "Conhecer BravAcademy",
  },
  {
    slug: "bravvideo",
    name: "BravVideo",
